...
# 모델 로딩
model_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'model_best_dict.pt')
     ...
     <head>
      ...
      <style>
        body {{ 
            ...
            background-image: url('https://www.docdocdoc.co.kr/news/photo/202309/3009225_3010434_1622.jpg'); /* 배경 이미지 추가 */
