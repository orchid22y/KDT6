...
def make_wordxloud(title_list,stopwords, word_count):
    okt = Okt()
    sentences_tag=[]
    ...
    if platform.system()=='Windows':
        path=r"C:\Users\KDP-27\anaconda3\Lib\site-packages\matplotlib\mpl-data\fonts\ttf\온글잎 언즈체.ttf"
    ...
    wordcloud=WordCloud(font_path=path, width=400, height=400,
